...
(function(artifactregistry_v1) {
    ...
    class Resource$Projects$Locations$Repositories {
        ...
        constructor(context){
            ...
            this.prewarmedArtifacts = new Resource$Projects$Locations$Repositories$Prewarmedartifacts(this.context);
        ...
        checkPrewarmedArtifact(paramsOrCallback, optionsOrCallback, callback) {
            let params = paramsOrCallback || {};
            let options = optionsOrCallback || {};
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+repository}:checkPrewarmedArtifact').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
        ...
        prewarmArtifact(paramsOrCallback, optionsOrCallback, callback) {
            let params = paramsOrCallback || {};
            let options = optionsOrCallback || {};
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+repository}:prewarmArtifact').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
        ...
        removePrewarmedArtifact(paramsOrCallback, optionsOrCallback, callback) {
            let params = paramsOrCallback || {};
            let options = optionsOrCallback || {};
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+repository}:removePrewarmedArtifact').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    class Resource$Projects$Locations$Repositories$Prewarmedartifacts {
        context;
        constructor(context){
            this.context = context;
        }
        list(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/prewarmedArtifacts').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: ''
                }, options),
                params,
    ...
    artifactregistry_v1.Resource$Projects$Locations$Repositories$Prewarmedartifacts = Resource$Projects$Locations$Repositories$Prewarmedartifacts;
