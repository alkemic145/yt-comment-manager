...
(function(networkconnectivity_v1) {
    ...
    class Resource$Projects$Locations {
        ...
        constructor(context){
            ...
            this.pscAuthorizationPolicies = new Resource$Projects$Locations$Pscauthorizationpolicies(this.context);
    ...
    class Resource$Projects$Locations$Pscauthorizationpolicies {
        context;
        constructor(context){
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/pscAuthorizationPolicies').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    networkconnectivity_v1.Resource$Projects$Locations$Pscauthorizationpolicies = Resource$Projects$Locations$Pscauthorizationpolicies;
