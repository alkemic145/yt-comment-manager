...
(function(sqladmin_v1) {
    ...
    class Resource$Connect {
        ...
        resolve(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/locations/{location}/dns/{dnsName}:resolveConnectSettings').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: ''
                }, options),
                params,
...
(function(sqladmin_v1beta4) {
    ...
    class Resource$Connect {
        ...
        resolve(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/sql/v1beta4/locations/{location}/dns/{dnsName}:resolveConnectSettings').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: ''
                }, options),
                params,
