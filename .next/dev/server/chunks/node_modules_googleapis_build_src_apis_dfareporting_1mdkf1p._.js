...
(function(dfareporting_v5) {
    ...
    class Resource$Reportdata {
        ...
        query(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/dfareporting/v5/userprofiles/{profileId}/reportdata/query').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    dfareporting_v5.Resource$Reportdata = Resource$Reportdata;
    class Resource$Reports {
        context;
        compatibleFields;
        files;
...
//# sourceMappingURL=node_modules_googleapis_build_src_apis_dfareporting_1mdkf1p._.js.map