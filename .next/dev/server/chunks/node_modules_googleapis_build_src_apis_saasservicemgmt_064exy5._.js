...
(function(saasservicemgmt_v1beta1) {
    ...
    class Resource$Projects$Locations {
        ...
        constructor(context){
            ...
            this.rollouts = new Resource$Projects$Locations$Rollouts(this.context);
            this.saas = new Resource$Projects$Locations$Saas(this.context);
            this.saasReleases = new Resource$Projects$Locations$Saasreleases(this.context);
            this.tenants = new Resource$Projects$Locations$Tenants(this.context);
            this.unitGroupOperations = new Resource$Projects$Locations$Unitgroupoperations(this.context);
            this.unitGroups = new Resource$Projects$Locations$Unitgroups(this.context);
            this.unitKinds = new Resource$Projects$Locations$Unitkinds(this.context);
            this.unitOperations = new Resource$Projects$Locations$Unitoperations(this.context);
            this.units = new Resource$Projects$Locations$Units(this.context);
        }
    ...
    class Resource$Projects$Locations$Saasreleases {
        context;
        constructor(context){
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/{+parent}/saasReleases').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    saasservicemgmt_v1beta1.Resource$Projects$Locations$Saasreleases = Resource$Projects$Locations$Saasreleases;
    class Resource$Projects$Locations$Tenants {
        context;
        constructor(context){
            this.context = context;
    ...
    class Resource$Projects$Locations$Unitgroupoperations {
        context;
        constructor(context){
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/{+parent}/unitGroupOperations').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    saasservicemgmt_v1beta1.Resource$Projects$Locations$Unitgroupoperations = Resource$Projects$Locations$Unitgroupoperations;
    class Resource$Projects$Locations$Unitgroups {
        context;
        constructor(context){
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/{+parent}/unitGroups').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    saasservicemgmt_v1beta1.Resource$Projects$Locations$Unitgroups = Resource$Projects$Locations$Unitgroups;
    class Resource$Projects$Locations$Unitkinds {
        context;
        constructor(context){
            this.context = context;
